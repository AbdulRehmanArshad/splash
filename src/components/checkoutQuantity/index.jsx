...
export class CheckoutQuantity extends Component {
  render() {
    return (
      <>
            ...
            <div className="row w-100">
              <div className="col-lg-12 col-md-12 col-12">
                ...
                >
                  <thead>
                    <tr>
                      <th className="text-white" style={{ width: "60%" }}>
                        Product
                      </th>
                      <th className="text-white" style={{ width: "12%" }}>
                        Price
                      </th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="text-white" data-th="Price">
                        $49.00
                      </td>
                      <td data-th="Quantity">
                        <input
